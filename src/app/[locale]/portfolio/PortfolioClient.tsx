...
const portfolioData = {
  youtube: {
    ...
    stats: [
      ...
      { value: '2.5M+', label: "ko'rishlar (28 kun)" },
      { value: '80K+', label: 'organik auditoriya' },
    ],
    items: [
      {
        src: '/images/portfolio/youtube/yt-analytics.png',
        name: "Kanal analitikasi — 2.5 mln ko'rish",
        desc: "So'nggi 28 kunda 2,503,722 ko'rish, 9,500+ soat tomosha vaqti va +1,400 yangi obunachi (>999% o'sish). Organik kontent strategiyamizning real natijasi.",
      },
      {
